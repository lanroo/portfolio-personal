        ...
        <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
                <div className="social-icon">
                    <a href="https://www.linkedin.com/in/yladacs/"><img src={navIcon1} alt="linkedin"></img></a>
                    <a href="bit.ly/whatsappyl"><img src={navIcon2} alt="whatsapp"></img></a>
                    <a href="https://github.com/lanroo"><img src={navIcon3} alt="github"></img></a>
                </div>
